...
export const Header = () => {
    ...
    // Флаги, были ли кнопки когда-либо нажаты
                            ...
                            <div className="p-20 pt-10">
                                ...
                                <div className="p-0">
                                    <div className="w">
                                        <button>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" fill="#667797" viewBox="0 0 256 256">
                                                <path className="t" d="M224,200h-8V40a8,8,0,0,0-8-8V24a8,8,0,0,0-16,0v8H96a8,8,0,0,0-8,8v40H48a8,8,0,0,0-8,8v64H32a8,8,0,0,0,0,16H224a8,8,0,0,0,0-16ZM160,48h40V200H160ZM104,96h40V200H104ZM56,144H88v56H56Z"></path>
                                            </svg>
                                            <p>Analytics</p>
                                        </button>
                                    </div>
...
<div className="dropdown" data-bs-auto-close="outside" >
    ...
    {/*всплывающее окно*/}
    <ul className="dropdown-menu "  style={{padding:'20px 20px', width:'330px', height:'407px' }}>
        ...
        <div className="sroll-button max-h-270 overflow-y-auto scroll-sm ">
            ...
            <button className="d-flex justify-content-start align-items-center flex-row hover-text-danger-600 hover-bg-danger-50  ">
                <div className="scroll_button_logo d-flex justify-content-center align-items-center ">
