...
export const Header = () => {
  ...
  <div className="card-down-button ">
    <button className="button-view-all">View All</button>
        ...
        {/*Радиокнопки*/}
        <div className="dropdown">
            <button className="text-gray-500 w-40 h-40 bg-main-50 hover-bg-main-100 transition-2 rounded-circle text-xl flex-center show" type="button" data-bs-toggle="dropdown" aria-expanded="true">
